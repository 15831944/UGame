#if !defined(_PAGE_DEFENSE_HEADER_)
#define _PAGE_DEFENSE_HEADER_
...
class CPageDefense : public CPageIcon , public ObserverBase
{
private:
  CFont font_list;
...
public:
	CPageDefense(UINT iconID = NULL , CWnd* pParent = NULL);   // standard constructor
...
#endif // !defined(_PAGE_DEFENSE_HEADER_)
