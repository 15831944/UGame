...
public:
    ...
    */
    ...
    /*!
        ...
        \param[in] OwnerID ID of the Attacker/Defender you want the fleet from
    ...
    */
    ...
    //!Set target resiurce
    void SetTargetResource(Res r , int FleetID);
    ...
    */
    ...
    __int64 GetFuel(PlaniPos& self_pos , PlaniPos& target_pos , const vector<SItem>& vFleet);
    ...
    //!attack and defender name
    void SetPlayerName(const char* att , const char* def)
    {
      PlayerName[0] = att;
      PlayerName[1] = def;
    }
