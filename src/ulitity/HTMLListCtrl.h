...
#define ITEM_IMAGE_PADDING_LEFT		0
...
#define HTMLLIST_ITEMDELETE		6
#define HTMLLIST_ITEMDELETEALL		7
...
public:
  ...
  void SetListColor(COLORREF col);
  void AdjustScrollBar();

	int InsertItem(CString sText,UINT uiImage,int nStyle=HTML_TEXT,int nHeight=AUTO , BOOL bTail = TRUE);
